...
export function SparklesHero() {
  return (
    <div className="h-[3rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md mt-2">
      <div className="w-[40rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full h-1/3 bg-black [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
      </div>
    </div>
  );
}
